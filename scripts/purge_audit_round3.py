"""Purge round 3 : 2 derniers mismatch identifies a la 2e relecture."""
import os, json
...
FLAGGED_R3 = {
    "ile-paradis",   # Lagon bleu = batiment bleu, pas un lagon
    "insecte-rond",  # Coccinelle = Miraculous Ladybug anime
}
